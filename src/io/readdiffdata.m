function experiment = readdiffdata(filename_dx,filename_xml)
...
%% Compute value of independent variable k as a function of e.g. gradient.

% Note that what is internally represented as delta is the true duration of
% the entire pulse, not the effective duration (an equivalent rectangular
% pulse). Thus, Bruke TopSpin's delta variable is not the same as what is
